...
<div class="p-4 bg-[#f8fafc] min-h-screen">
    <div class="flex justify-between items-center mb-8 px-4">
        ...
        <a href="{{ route('users.create') }}"
            class="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white hover:bg-blue-700 rounded-xl transition text-xs font-bold uppercase tracking-widest shadow-md">
            ...
            <table class="w-full text-left text-sm text-slate-600">
                ...
                <tbody class="divide-y divide-gray-50 font-medium">
                    @forelse($users as $user)
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-8 py-5">
                                @if($user->is_admin)
                                    <span
                                        class="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg text-xs font-black uppercase tracking-widest">Admin</span>
                                @else
                                    <span
                                        class="px-3 py-1 bg-gray-100 text-gray-600 rounded-lg text-xs font-black uppercase tracking-widest">Standard</span>
                                @endif
                            </td>
                            <td class="px-8 py-5">
                    ...
                    @empty
                        <tr>
                            <td colspan="4"
                                class="px-8 py-10 text-center text-slate-400 font-black uppercase tracking-widest text-sm">
                                No users found.</td>
                        </tr>
                    @endforelse
                </tbody>
