...
@section('auth_header')
<div
    style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding-top: 1rem; padding-bottom: 0.5rem;">
    <img src="{{ asset('vendor/adminlte/dist/img/stc_logo5.png') }}" alt="Mayor's Office Logo" style="width: 72px; height: 72px; object-fit: contain; display: block; margin: 0 auto;
                    filter: drop-shadow(0 3px 6px rgba(0,0,0,0.12));">
    <h5
        style="margin-top: 0.75rem; margin-bottom: 0; font-weight: 900; color: #1e293b; text-transform: uppercase; letter-spacing: -0.02em;">
        Management Information <span style="color: #3b82f6;">System Office</span>
    </h5>
    <p style="font-size: 11px; letter-spacing: 0.15em; text-transform: uppercase; color: #94a3b8; margin-bottom: 0;">
        Fingerlock - Usermanagement
    </p>
...
@if($passResetUrl)
    <div class="text-center py-2">
        <a href="{{ $passResetUrl }}" class="text-muted" style="font-size: 12px; text-decoration: none;">
